          ...
          <div className="mt-6 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 items-start gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-2 inline-flex items-center gap-1.5 text-sm text-[var(--secondary-text)]">
                  <MapPin className="size-4 shrink-0" />
                  {tradesman.location}
                </p>
              </div>
        ...
        <section className="rounded-2xl border border-[#E5E7EB] bg-white p-4 sm:p-6 lg:p-8">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="rounded-xl bg-[#F8FAFC] p-4">
              <p className="inline-flex items-center gap-2 text-xs font-medium text-[var(--secondary-text)]">

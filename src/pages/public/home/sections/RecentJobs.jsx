  ...
  return (
    <section data-scroll-section className="bg-white py-16 lg:py-20">
      <div className="container mx-auto px-6 lg:px-8">
        <div data-scroll-header className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
          ...
          <Link
            to="/jobs"
            className="inline-flex shrink-0 items-center justify-center rounded-lg bg-btn-primary px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#0150CC]"
          >
            Browse All Jobs
          </Link>
        </div>
